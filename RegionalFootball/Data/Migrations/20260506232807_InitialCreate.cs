    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubContributors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClubContributors_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClubContributors_Clubs_ClubId",
                        column: x => x.ClubId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AwayScore = table.Column<int>(type: "integer", nullable: true),
                    Notes = table.Column<string>(type: "text", nullable: false),
                    StatusReview = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchUpdateProposals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MatchUpdateProposals_AspNetUsers_ProposedByUserId",
                        column: x => x.ProposedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MatchUpdateProposals_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClubContributors_ClubId_UserId",
                table: "ClubContributors",
                columns: new[] { "ClubId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClubContributors_UserId",
                table: "ClubContributors",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchUpdateProposals_MatchId",
                table: "MatchUpdateProposals",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchUpdateProposals_ProposedByUserId",
                table: "MatchUpdateProposals",
